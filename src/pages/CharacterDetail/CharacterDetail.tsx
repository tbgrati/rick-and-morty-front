...
import {Episode} from "../../modules/types/Episode.ts";
...
export const CharacterDetailPage = () => {
    ...
    const { episodes: episodeData = [], loading: loadingEpisode, error: errorEpisode } = useGetMultipleEpisodes(character?.episode || []);
    ...
    return (
        <div className="flex flex-col w-3/5 items-center mx-auto py-10 bg-primary-500  border-ram-blue-700 gap-y-6 rounded-lg mt-10">
            ...
            <div className="w-full px-6">
                <h1 className="font-bold text-6xl border-b-1">{character?.name}</h1>
            </div>
                    ...
                    <div className="p-1 border-2 rounded-md border-ram-blue-700 w-full max-w-sm">
                        ...
                        <div className="mx-auto">
                            {[
                                ...
                                { label: "TYPE", value: (character?.type? character.type : "Normal") },
                                ...
                                >
                                    ...
                                    <span className="col-span-2 px-4 py-2">{value || "Unknown"}</span>
                                </div>
                            ))}
                        </div>
                    </div>
