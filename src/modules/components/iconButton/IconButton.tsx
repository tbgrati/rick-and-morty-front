...
const IconButton: React.FC<IconButtonProps> = ({ icon, variant, size, rounded, className, ...rest }) => {
    return (
        <button {...rest} className={clsx(iconButtonVariant({ variant, size, rounded }), className)}>
            {icon}
        </button>
    );
};
