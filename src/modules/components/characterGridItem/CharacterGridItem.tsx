...
export const CharacterGridItem = ({ url, image, name, status, species, type, origin }: Props) => {
    const id = url.split("/api/character/")[1]?.split("/")[0] || "";

    return (
        <div className="max-w-80 rounded-lg bg-primary-400 overflow-hidden transition-transform duration-200 ease-in-out transform hover:scale-105 shadow-md">
            <img
                src={image}
                alt="Character"
